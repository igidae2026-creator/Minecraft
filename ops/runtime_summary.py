...
def main() -> int:
    ...
    print(f"CONTENT_SOCIAL_CONCURRENCY_STRENGTH={content_governor.get('social_concurrency_strength', 0)}")
    ...
    print(f"MINECRAFT_LONG_SOAK_CONFIDENCE={minecraft_soak.get('long_soak_confidence', 0)}")
    ...
    print(f"ANTI_CHEAT_EXPLOIT_RESILIENCE_SCORE={anti_cheat_governor.get('exploit_resilience_score', 0)}")
    ...
    print(f"LIVEOPS_PARTY_CONCURRENCY_SUPPORT={liveops_governor.get('party_concurrency_support', 0)}")
